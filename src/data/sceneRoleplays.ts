...
export const SCENE_ROLEPLAYS: readonly SceneRoleplay[] = [
  ...
  f("fastfood", "Fast Food", "注文・持ち帰り・支払い", [
    q("fastfood-combo", "Counter order", "a customer ordering at a quick-service food counter", "a quick-service counter employee", "Take a food and drink order, confirm the relevant type, size, or quantity and for-here or to-go choice, then complete payment.", ["r311", "r315", "s412", "r334"], ["One menu item is sold out.", "The requested size is unavailable."]),
    q("fastfood-burger", "Quick order", "a customer ordering a simple item and any suitable extra", "a quick-service counter employee", "Take the order one short question at a time, confirm whether anything else is needed, then complete payment.", ["r311", "r315", "h166", "r336"], ["The employee needs to ask the customer to repeat one item.", "The customer is asked to choose a different suitable option."]),
    ...
    q("fastfood-pickup", "Checking the order", "a customer collecting a quick-service order", "a quick-service counter employee", "Confirm the order number and contents, resolve any small difference, and finish the pickup.", ["r341", "r347", "t230", "h153"], ["One item in the order is different.", "The customer asks for a suitable condiment, sugar, milk, or a napkin."]),
  ]),
];
